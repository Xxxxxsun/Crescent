...
output_file="llama2_questions_num${total_prompts}_temp${temperature}_topp${top_p}_${timestamp}.json"
...
CUDA_VISIBLE_DEVICES=$gpu_id python ../questions/gen_questions_deduplicate_llama2_fast.py \
    --model $model_path \
...
CUDA_VISIBLE_DEVICES=$gpu_id python ../answers/generate_two_way_answers_update3_llama2.py \
