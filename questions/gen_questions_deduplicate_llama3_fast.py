...
def parse_arguments():
    ...
    parser.add_argument("--model", type=str, default="/data1/syt/syt3/syt/models/Meta-Llama3-8B-Instruct", help="Model to use")
    ...
    parser.add_argument("--output_file", type=str, default="llama3_test.json", help="Output file name")
...
sentence_model = SentenceTransformer("/data1/syt/syt3/syt/models/all-MiniLM-L6-v2", device='cuda:1', trust_remote_code=True)
...
def main():
    ...
    for i in enumerate(tqdm(range(args.num_prompts), desc="Generating responses")):
        ...
        raw_prompts = ["Use your creativity, create one unique, special, diverse, high school level math word problem. Please provide only the problem, no any other words. \n\nProblem: " for _ in range(1)]
    ...
    total_gpu_hours = (total_time_seconds / 3600) * 1
