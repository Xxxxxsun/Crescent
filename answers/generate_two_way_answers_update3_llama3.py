...
def get_args():
    ...
    parser.add_argument("--model_path", type=str, default="/data1/syt/models/Meta-Llama3-8B-Instruct", help="Default model path if not specified in gen_config.")
    parser.add_argument("--input_file", type=str, default="../questions/llama3_test.json", help="Input dataset file name")
